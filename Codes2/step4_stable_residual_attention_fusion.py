...
# optimizer = optim.AdamW(model.parameters(), lr=1e-4) # Best Validation Accuracy: 0.9224924012158054
# Lower learning rate 
# optimizer = torch.optim.AdamW(model.parameters(), lr=5e-5) # Best Validation Accuracy: 0.9209726443768997
# with weight decay
optimizer = torch.optim.AdamW(model.parameters(), lr=5e-5, weight_decay=1e-4) # Best Validation Accuracy: 0.9209726443768997
