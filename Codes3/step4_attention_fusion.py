...
RESULTS_DIR = "results_attention_fusion"
...
class AttentionFusionModel(nn.Module):
    ...
    def forward(self, swin_feat, lesion_feat):
        attention_weights = self.attention_net(lesion_feat)
        weighted_swin = swin_feat * attention_weights
...
plt.plot([0,1],[0,1],'k--')
plt.title("ROC - Attention Fusion")
plt.legend()
plt.tight_layout()
...
print("\nAttention Fusion Training Complete.")
